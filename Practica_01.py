...
for name in names:
    print("Que onda amigo "+str(name))

"""Deseos"""
deseos=['terminar mi tarea de progra','nunca enfermar','graduarme de la universidad','ser mas alto',
        'aprender mas de tres idiomas','que ella me ame ):','no ser tan timido','viajar por el mundo',
        'tener la mejor coleccion de sneakers','aprender surf','viajar en el tiempo','viajar al espacio',
        'ser un de los mejores tatuadores','comprar una moto','tener un  buen trabajo']
print(deseos[0].title())
print(deseos[5].title())
print(deseos[8].title())
